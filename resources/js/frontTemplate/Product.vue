<template>
    <Layout>
        <template v-slot:content>
            ...
            <main role="main">
                <div id="shopify-section-template--14201418481737__product-template" class="shopify-section">
    ...
    <span>
      ...
      <span class="cart-unavailable">Uavailable</span>
                ...
                <div id="shopify-section-template--14201418481737__single-product-tab" class="shopify-section">
                                            ...
                                            <div class="spr-container">
                                                <div class="spr-header">
                                                    ...
                                                    <div class="spr-summary">
                                                        <span class="spr-summary-caption">No reviews yet</span><span
                                                        class="spr-summary-actions">
        <a href='#' class='spr-summary-actions-newreview' onclick='SPR.toggleForm(1595619409993);return false'>Write a review</a>
      </span>
                                                    </div>
                                                </div>

                                                <div class="spr-content">
                                                    <div class='spr-form' id='form_1595619409993'
                                                         style='display: none'></div>
                                                    <div class='spr-reviews' id='reviews_1595619409993'
                                                         style='display: none'></div>
                                                </div>
                ...
                <div id="shopify-section-template--14201418481737__related-product" class="shopify-section">
                                ...
                                <div class="col">
                                    ...
                                    <div class="single-product-wrap">
                                        <div class="product-image">
                                            ...
                                            <a href="humor-new-agregado.html">
                                                <img
        ...
        <span>
          ...
          <span class="cart-unavailable"><i class="ion-android-alert"></i></span>
                                                ...
                                                <a href="javascript:void(0);"
                                                   onclick="quiqview('humor-new-agregado')" class="quick-view"
                                                   data-toggle="modal" data-target="#exampleModalCenter"><i
                                                    class="icon-magnifier-add"></i></a>
                                            </div>
                                        </div>
                                        <div class="product-content">
                                            <h3><a href="humor-new-agregado.html">Humor New Agregado</a></h3>
                                            <div class="price-box">
                                ...
                                <div class="col">
                                    ...
                                    <div class="single-product-wrap">
                                        <div class="product-image">
                                            ...
                                            <a href="aquellos-interesados.html">
                                                <img
        ...
        <span>
          ...
          <span class="cart-unavailable"><i class="ion-android-alert"></i></span>
                                                ...
                                                <a href="javascript:void(0);"
                                                   onclick="quiqview('aquellos-interesados')" class="quick-view"
                                                   data-toggle="modal" data-target="#exampleModalCenter"><i
                                                    class="icon-magnifier-add"></i></a>
                                            </div>
                                        </div>
                                        <div class="product-content">
                                            <h3><a href="aquellos-interesados.html">Aquellos Interesados</a></h3>
                                            <div class="price-box">
        ...
        <span>
          ...
          <span class="cart-unavailable"><i class="ion-android-alert"></i></span>
                                                ...
                                                <a href="javascript:void(0);"
                                                   onclick="quiqview('algunas-veces-por')" class="quick-view"
                                                   data-toggle="modal" data-target="#exampleModalCenter"><i
                                                    class="icon-magnifier-add"></i></a>
                                            </div>
                                        </div>
                                        <div class="product-content">
                                            <h3><a href="algunas-veces-por.html">Algunas Veces Por</a></h3>
                                            <div class="price-box">
        ...
        <span>
          ...
          <span class="cart-unavailable"><i class="ion-android-alert"></i></span>
                                                ...
                                                <a href="javascript:void(0);"
                                                   onclick="" class="quick-view"
                                                   data-toggle="modal" data-target="#exampleModalCenter"><i
                                                    class="icon-magnifier-add"></i></a>
                                            </div>
                                        </div>
                                        <div class="product-content">
                                            <h3><a href="">Combinadas Con</a></h3>
                                            <div class="price-box">
                                    ...
                                    <div class="single-product-wrap">
                                        <div class="product-image">
                                            ...
                                            <div class="product-action">
                                                ...
                                                <a href="javascript:void(0);"
                                                   onclick="quiqview('affiliate-product')" class="quick-view"
                                                   data-toggle="modal" data-target="#exampleModalCenter"><i
                                                    class="icon-magnifier-add"></i></a>
                                            </div>
                                        </div>
                                        <div class="product-content">
                                            <h3><a href="affiliate-product.html">Affiliate Product</a></h3>
                                            <div class="price-box">
