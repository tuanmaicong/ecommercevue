        ...
        <div class="product-area section-ptb"
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="section-title">
                            ...
                            <h2>Sản phẩm sale</h2>
                            <p>Sản phẩm thuộc chương trình khuyến mãi chào mừng ngày lễ 30/4-1/5</p>
                ...
                <div class="product-warpper">
                    <div class="row">
                        <div v-for="item in homeProductSale"  class="col-lg-3 col-md-4 col-sm-6">
